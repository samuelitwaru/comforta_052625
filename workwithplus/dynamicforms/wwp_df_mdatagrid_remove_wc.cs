...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_mdatagrid_remove_wc : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256412215165", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_mdatagrid_remove_wc.js", "?20256412215165", false, true);
