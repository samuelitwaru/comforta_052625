...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_mcheckbox_wc : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255245384323", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_mcheckbox_wc.js", "?20255245384323", false, true);
         }
