...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateTrn_AppVersion( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_AppVersion (AppVersionId CHAR(36) NOT NULL , AppVersionName VARCHAR(100) NOT NULL , LocationId CHAR(36) , IsActive BOOLEAN NOT NULL , OrganisationId CHAR(36) , IsVersionDeleted BOOLEAN NOT NULL , VersionDeletedAt timestamp without time zone , PRIMARY KEY(AppVersionId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_Location( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_Location (LocationId CHAR(36) NOT NULL , OrganisationId CHAR(36) NOT NULL , LocationName VARCHAR(100) NOT NULL , LocationEmail VARCHAR(100) NOT NULL , LocationPhone CHAR(20) NOT NULL , LocationDescription TEXT NOT NULL , LocationCity VARCHAR(100) NOT NULL , LocationZipCode VARCHAR(100) NOT NULL , LocationAddressLine1 VARCHAR(100) NOT NULL , LocationAddressLine2 VARCHAR(100) NOT NULL , LocationPhoneCode VARCHAR(40) NOT NULL , LocationPhoneNumber VARCHAR(9) NOT NULL , LocationCountry VARCHAR(100) NOT NULL , Trn_ThemeId CHAR(36) , LocationImage BYTEA NOT NULL , LocationImage_GXI VARCHAR(2048) , ToolBoxDefaultLogo VARCHAR(200) , ToolBoxDefaultProfileImage VARCHAR(200) , LocationBrandTheme TEXT , LocationCtaTheme TEXT , LocationHasMyCare BOOLEAN NOT NULL , LocationHasMyServices BOOLEAN NOT NULL , LocationHasMyLiving BOOLEAN NOT NULL , LocationHasOwnBrand BOOLEAN NOT NULL , ReceptionImage BYTEA , ReceptionImage_GXI VARCHAR(2048) , ReceptionDescription VARCHAR(200) , LocationThemeId CHAR(36) , ActiveAppVersionId CHAR(36) , PublishedActiveAppVersionId CHAR(36) , PRIMARY KEY(LocationId, OrganisationId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void RITrn_AppVersionTrn_Organisation( )
      {
         ...
         try
         {
            cmdBuffer=" ALTER TABLE Trn_AppVersion ADD CONSTRAINT GX_002M000B FOREIGN KEY (OrganisationId) REFERENCES Trn_Organisation (OrganisationId) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE Trn_AppVersion DROP CONSTRAINT GX_002M000B "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateTrn_SupplierDynamicForm" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "CreateTrn_LocationImage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "CreateTrn_ServiceImage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 4 ,  "CreateTrn_DiscussionTranslation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 5 ,  "CreateTrn_DynamicFormTranslation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 6 ,  "CreateTrn_DynamicTranslation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 7 ,  "CreateTrn_Memo" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 8 ,  "CreateTrn_MemoCategory" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 9 ,  "CreateTrn_ThemeCtaColor" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 10 ,  "CreateTrn_ResidentPackage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 11 ,  "CreateTrn_AppVersionPage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 12 ,  "CreateTrn_AppVersion" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 13 ,  "CreateTrn_OrganisationSetting" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 14 ,  "CreateTrn_OrganisationDynamicForm" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 15 ,  "CreateTrn_Page" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 16 ,  "CreateTrn_ResidentNotification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 17 ,  "CreateTrn_AppNotification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 18 ,  "CreateTrn_AgendaEventGroup" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 19 ,  "CreateTrn_ThemeIcon" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 20 ,  "CreateTrn_Media" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 21 ,  "CreateTrn_PreferredGenSupplier" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 22 ,  "CreateTrn_PreferredAgbSupplier" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 23 ,  "CreateTrn_Audit" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 24 ,  "CreateTrn_CallToAction" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 25 ,  "CreateTrn_LocationDynamicForm" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 26 ,  "CreateTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 27 ,  "CreateTrn_Device" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 28 ,  "CreateTrn_Resident" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 29 ,  "CreateTrn_Receptionist" , new Object[]{ });
      ...
      private void ExecuteOnlyRisReorganization( )
      {
         ...
         ReorgExecute.RegisterBlockForSubmit( 67 ,  "RITrn_LocationTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 68 ,  "RITrn_LocationTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 69 ,  "RITrn_LocationTrn_Theme1" , new Object[]{ });
         ...
         ReorgExecute.RegisterBlockForSubmit( 119 ,  "RITrn_AppVersionTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 120 ,  "RITrn_AppVersionTrn_Location" , new Object[]{ });
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_SupplierDynamicForm", ""}) );
         ...
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_LocationImage", ""}) );
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ServiceImage", ""}) );
         GXReorganization.SetMsg( 4 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_DiscussionTranslation", ""}) );
         GXReorganization.SetMsg( 5 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_DynamicFormTranslation", ""}) );
         GXReorganization.SetMsg( 6 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_DynamicTranslation", ""}) );
         GXReorganization.SetMsg( 7 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Memo", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Memo" ,  "CreateTrn_Resident" );
         GXReorganization.SetMsg( 8 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_MemoCategory", ""}) );
         GXReorganization.SetMsg( 9 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ThemeCtaColor", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ThemeCtaColor" ,  "CreateTrn_Theme" );
         GXReorganization.SetMsg( 10 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ResidentPackage", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ResidentPackage" ,  "CreateTrn_Location" );
         GXReorganization.SetMsg( 11 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AppVersionPage", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_AppVersionPage" ,  "CreateTrn_AppVersion" );
         GXReorganization.SetMsg( 12 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AppVersion", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_AppVersion" ,  "CreateTrn_Organisation" );
         ReorgExecute.RegisterPrecedence( "CreateTrn_AppVersion" ,  "CreateTrn_Location" );
         GXReorganization.SetMsg( 13 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_OrganisationSetting", ""}) );
         ...
         GXReorganization.SetMsg( 14 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_OrganisationDynamicForm", ""}) );
         ...
         GXReorganization.SetMsg( 15 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Page", ""}) );
         ...
         GXReorganization.SetMsg( 16 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ResidentNotification", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ResidentNotification" ,  "CreateTrn_AppNotification" );
         GXReorganization.SetMsg( 17 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AppNotification", ""}) );
         GXReorganization.SetMsg( 18 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AgendaEventGroup", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_AgendaEventGroup" ,  "CreateTrn_AgendaCalendar" );
         GXReorganization.SetMsg( 19 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ThemeIcon", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ThemeIcon" ,  "CreateTrn_Theme" );
         GXReorganization.SetMsg( 20 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Media", ""}) );
         GXReorganization.SetMsg( 21 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_PreferredGenSupplier", ""}) );
         GXReorganization.SetMsg( 22 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_PreferredAgbSupplier", ""}) );
         GXReorganization.SetMsg( 23 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Audit", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Audit" ,  "CreateTrn_Organisation" );
         GXReorganization.SetMsg( 24 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_CallToAction", ""}) );
         ...
         GXReorganization.SetMsg( 25 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_LocationDynamicForm", ""}) );
         ...
         GXReorganization.SetMsg( 26 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ProductService", ""}) );
         ...
         GXReorganization.SetMsg( 27 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Device", ""}) );
         GXReorganization.SetMsg( 28 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Resident", ""}) );
         ...
         GXReorganization.SetMsg( 29 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Receptionist", ""}) );
      ...
      private void SetPrecedenceris( )
      {
         ...
         GXReorganization.SetMsg( 69 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION2"}) );
         ReorgExecute.RegisterPrecedence( "RITrn_LocationTrn_Theme1" ,  "CreateTrn_Location" );
         ReorgExecute.RegisterPrecedence( "RITrn_LocationTrn_Theme1" ,  "CreateTrn_Theme" );
         ...
         GXReorganization.SetMsg( 119 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"GX_002M000B"}) );
         ReorgExecute.RegisterPrecedence( "RITrn_AppVersionTrn_Organisation" ,  "CreateTrn_AppVersion" );
         ReorgExecute.RegisterPrecedence( "RITrn_AppVersionTrn_Organisation" ,  "CreateTrn_Organisation" );
         GXReorganization.SetMsg( 120 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_APPVERSION1"}) );
