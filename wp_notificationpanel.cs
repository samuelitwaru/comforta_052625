   ...
   public class wp_notificationpanel : GXDataArea
   {
      ...
      protected void E127P2( )
      {
         ...
         if ( AV10CheckRequiredFieldsResult )
         {
            ...
            new prc_sendresidentnotification(context ).execute(  AV7Title,  AV8Message,  context.GetMessage( "GENERAL", ""),  AV13Metadata,  AV12ResidentIdCollectionEmpty) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256217522133", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_notificationpanel.js", "?20256217522134", false, true);
