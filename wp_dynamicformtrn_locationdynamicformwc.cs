...
namespace GeneXus.Programs {
   public class wp_dynamicformtrn_locationdynamicformwc : GXWebComponent
   {
      ...
      protected void E19B52( )
      {
         ...
         returnInSub = false;
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "workwithplus.dynamicforms.wwp_createdynamicform.aspx"+UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.RTrim("")) + "," + UrlEncode(StringUtil.LTrimStr(AV7WWPFormType,1,0));
      ...
      protected void S272( )
      {
         ...
         if ( AV47NewWWPForm.Insert() )
         {
            ...
            if ( ! (Guid.Empty==AV5LocationId) )
            {
               ...
               AV77Trn_LocationDynamicForm.gxTpr_Locationid = AV5LocationId;
               AV77Trn_LocationDynamicForm.gxTpr_Organisationid = AV6OrganisationId;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255245495176", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_dynamicformtrn_locationdynamicformwc.js", "?20255245495178", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUSERACTIONINSERT'","""{"handler":"E19B52","iparms":[{"av":"AV7WWPFormType","fld":"vWWPFORMTYPE","pic":"9"}]}""");
