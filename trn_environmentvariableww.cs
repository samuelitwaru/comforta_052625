...
namespace GeneXus.Programs {
   public class trn_environmentvariableww : GXDataArea
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ENVIRONMENTVARIABLEID", GetSecureSignedToken( "", A633EnvironmentVariableId, context));
         GxWebStd.gx_hidden_field( context, "ENVIRONMENTVARIABLEID", A633EnvironmentVariableId.ToString());
      }
      ...
      protected void RFBP2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A635EnvironmentVariableValue = H00BP2_A635EnvironmentVariableValue[0];
               A634EnvironmentVariableKey = H00BP2_A634EnvironmentVariableKey[0];
               A633EnvironmentVariableId = H00BP2_A633EnvironmentVariableId[0];
               /* Execute user event: Grid.Load */
               E20BP2 ();
      ...
      protected void send_integrity_lvl_hashesBP2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DELETE", AV41IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( "", AV41IsAuthorized_Delete, context));
         GxWebStd.gx_hidden_field( context, "gxhash_ENVIRONMENTVARIABLEID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sGXsfl_39_idx, A633EnvironmentVariableId, context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV42IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV42IsAuthorized_Insert, context));
      }
      ...
      protected void S202( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_environmentvariableview.aspx"+UrlEncode(A633EnvironmentVariableId.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561013224024", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_environmentvariableww.js", "?202561013224027", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEnvironmentVariableId_Internalname,A633EnvironmentVariableId.ToString(),A633EnvironmentVariableId.ToString(),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEnvironmentVariableId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)39,(short)0,(short)0,(short)0,(bool)true,(string)"Id",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl39( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A633EnvironmentVariableId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A634EnvironmentVariableKey));
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtEnvironmentVariableKey_Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A635EnvironmentVariableValue));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E21BP2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV38ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV12OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV43Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV26TFEnvironmentVariableKey","fld":"vTFENVIRONMENTVARIABLEKEY"},{"av":"AV27TFEnvironmentVariableKey_Sel","fld":"vTFENVIRONMENTVARIABLEKEY_SEL"},{"av":"AV28TFEnvironmentVariableValue","fld":"vTFENVIRONMENTVARIABLEVALUE"},{"av":"AV29TFEnvironmentVariableValue_Sel","fld":"vTFENVIRONMENTVARIABLEVALUE_SEL"},{"av":"AV39IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV40IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV42IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A633EnvironmentVariableId","fld":"ENVIRONMENTVARIABLEID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV48Trn_environmentvariablewwds_5_tfenvironmentvariablevalue_sel = "";
         AV47Trn_environmentvariablewwds_4_tfenvironmentvariablevalue = "";
         H00BP2_A635EnvironmentVariableValue = new string[] {""} ;
         H00BP2_A634EnvironmentVariableKey = new string[] {""} ;
         H00BP2_A633EnvironmentVariableId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_environmentvariableww__default(),
            new Object[][] {
                new Object[] {
               H00BP2_A635EnvironmentVariableValue, H00BP2_A634EnvironmentVariableKey, H00BP2_A633EnvironmentVariableId
               }
               , new Object[] {
      ...
      private string[] H00BP2_A635EnvironmentVariableValue ;
      private string[] H00BP2_A634EnvironmentVariableKey ;
      private Guid[] H00BP2_A633EnvironmentVariableId ;
   ...
   public class trn_environmentvariableww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00BP2( IGxContext context ,
                                             ...
                                             string A634EnvironmentVariableKey ,
                                             string A635EnvironmentVariableValue ,
                                             short AV12OrderedBy ,
                                             bool AV13OrderedDsc )
      {
