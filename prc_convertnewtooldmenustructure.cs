   ...
   public class prc_convertnewtooldmenustructure : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A273Trn_ThemeId = P00DU2_A273Trn_ThemeId[0];
            n273Trn_ThemeId = P00DU2_n273Trn_ThemeId[0];
         ...
         while ( AV23GXV1 <= AV8SDT_MenuPage.gxTpr_Rows.Count )
         {
            ...
            while ( AV24GXV2 <= AV12RowsItem.gxTpr_Tiles.Count )
            {
               ...
               if ( StringUtil.StrCmp(AV14TilesItem.gxTpr_Action.gxTpr_Objecttype, "DynamicForm") == 0 )
               {
                  ...
                  /* Using cursor P00DU3 */
                  pr_default.execute(1, new Object[] {AV14TilesItem.gxTpr_Action.gxTpr_Objectid});
                  while ( (pr_default.getStatus(1) != 101) )
                  {
                     A206WWPFormId = P00DU3_A206WWPFormId[0];
                     A208WWPFormReferenceName = P00DU3_A208WWPFormReferenceName[0];
                     A207WWPFormVersionNumber = P00DU3_A207WWPFormVersionNumber[0];
      ...
      public override void initialize( )
      {
         ...
         P00DU2_A273Trn_ThemeId = new Guid[] {Guid.Empty} ;
         P00DU2_n273Trn_ThemeId = new bool[] {false} ;
         ...
         AV15SDT_Col = new SdtSDT_Col(context);
         AV11SDT_Tile = new SdtSDT_Tile(context);
         P00DU3_A206WWPFormId = new short[1] ;
         P00DU3_A208WWPFormReferenceName = new string[] {""} ;
         P00DU3_A207WWPFormVersionNumber = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_convertnewtooldmenustructure__default(),
            new Object[][] {
                new Object[] {
               P00DU2_A29LocationId, P00DU2_A11OrganisationId, P00DU2_A273Trn_ThemeId, P00DU2_n273Trn_ThemeId
               }
               , new Object[] {
               P00DU3_A206WWPFormId, P00DU3_A208WWPFormReferenceName, P00DU3_A207WWPFormVersionNumber
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00DU2_A273Trn_ThemeId ;
      private bool[] P00DU2_n273Trn_ThemeId ;
      ...
      private short[] P00DU3_A206WWPFormId ;
      private string[] P00DU3_A208WWPFormReferenceName ;
      private short[] P00DU3_A207WWPFormVersionNumber ;
   ...
   public class prc_convertnewtooldmenustructure__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00DU2", "SELECT LocationId, OrganisationId, Trn_ThemeId FROM Trn_Location WHERE LocationId = :AV18LocationId ORDER BY LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00DU2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00DU3", "SELECT WWPFormId, WWPFormReferenceName, WWPFormVersionNumber FROM WWP_Form WHERE WWPFormId = TO_NUMBER(0 || :AV14Tile_1Action_1Objectid,'9999999999999999999999999999.99999999999999') ORDER BY WWPFormId, WWPFormVersionNumber ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00DU3,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
