   ...
   public class prc_homepageapi : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            AV23ResidentLanguage = A599ResidentLanguage;
         ...
         while ( (pr_default.getStatus(2) != 101) )
         {
            ...
            n273Trn_ThemeId = P00GB4_n273Trn_ThemeId[0];
            ...
            while ( (pr_default.getStatus(3) != 101) )
            {
               ...
               GXt_char1 = AV24PagePublishedStructure;
               new prc_getdynamictranslation(context ).execute(  A516PageId,  AV23ResidentLanguage,  A536PagePublishedStructure, out  GXt_char1) ;
               AV24PagePublishedStructure = GXt_char1;
               AV11SDT_InfoPage.FromJSonString(AV24PagePublishedStructure, null);
         ...
         while ( AV29GXV1 <= AV11SDT_InfoPage.gxTpr_Infocontent.Count )
         {
            ...
            if ( StringUtil.StrCmp(AV13InfoContent.gxTpr_Infotype, "Images") == 0 )
            {
               ...
               AV22Images = (GxSimpleCollection<string>)(new GxSimpleCollection<string>());
               AV30GXV2 = 1;
               while ( AV30GXV2 <= AV13InfoContent.gxTpr_Images.Count )
               {
                  AV21InfoImageString = ((string)AV13InfoContent.gxTpr_Images.Item(AV30GXV2));
                  AV18InfoImage = new SdtSDT_InfoImage_SDT_InfoImageItem(context);
                  AV18InfoImage.FromJSonString(AV21InfoImageString, null);
                  AV22Images.Add(AV18InfoImage.gxTpr_Infoimagevalue, 0);
                  AV30GXV2 = (int)(AV30GXV2+1);
               }
               AV13InfoContent.gxTpr_Images = AV22Images;
            }
            ...
            {
               AV31GXV3 = 1;
               while ( AV31GXV3 <= AV13InfoContent.gxTpr_Tiles.Count )
               {
                  AV15SDT_InfoTile = ((SdtSDT_InfoTile_SDT_InfoTileItem)AV13InfoContent.gxTpr_Tiles.Item(AV31GXV3));
                  GXt_char1 = "";
                  ...
                  {
                     /* Using cursor P00GB6 */
                     pr_default.execute(4, new Object[] {AV15SDT_InfoTile.gxTpr_Action.gxTpr_Objectid});
      ...
      protected void S111( )
      {
         ...
         returnInSub = false;
         /* Using cursor P00GB7 */
         pr_default.execute(5, new Object[] {AV8LocationId});
         while ( (pr_default.getStatus(5) != 101) )
         {
            A584ActiveAppVersionId = P00GB7_A584ActiveAppVersionId[0];
            n584ActiveAppVersionId = P00GB7_n584ActiveAppVersionId[0];
            A598PublishedActiveAppVersionId = P00GB7_A598PublishedActiveAppVersionId[0];
            n598PublishedActiveAppVersionId = P00GB7_n598PublishedActiveAppVersionId[0];
            A29LocationId = P00GB7_A29LocationId[0];
            n29LocationId = P00GB7_n29LocationId[0];
            A11OrganisationId = P00GB7_A11OrganisationId[0];
            n11OrganisationId = P00GB7_n11OrganisationId[0];
            /* Using cursor P00GB8 */
            ...
            A273Trn_ThemeId = P00GB9_A273Trn_ThemeId[0];
            n273Trn_ThemeId = P00GB9_n273Trn_ThemeId[0];
            pr_default.close(7);
            AV14ThemeId = A273Trn_ThemeId;
      ...
      public override void initialize( )
      {
         ...
         P00GB4_n273Trn_ThemeId = new bool[] {false} ;
         ...
         AV24PagePublishedStructure = "";
         AV13InfoContent = new SdtSDT_InfoPage_InfoContentItem(context);
         AV22Images = new GxSimpleCollection<string>();
         AV21InfoImageString = "";
         AV18InfoImage = new SdtSDT_InfoImage_SDT_InfoImageItem(context);
         ...
         GXt_char1 = "";
         GXt_char2 = "";
         P00GB7_A584ActiveAppVersionId = new Guid[] {Guid.Empty} ;
         P00GB7_n584ActiveAppVersionId = new bool[] {false} ;
         P00GB7_A598PublishedActiveAppVersionId = new Guid[] {Guid.Empty} ;
         P00GB7_n598PublishedActiveAppVersionId = new bool[] {false} ;
         P00GB7_A29LocationId = new Guid[] {Guid.Empty} ;
         P00GB7_n29LocationId = new bool[] {false} ;
         P00GB7_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00GB7_n11OrganisationId = new bool[] {false} ;
         P00GB8_A273Trn_ThemeId = new Guid[] {Guid.Empty} ;
         P00GB8_n273Trn_ThemeId = new bool[] {false} ;
         P00GB9_A273Trn_ThemeId = new Guid[] {Guid.Empty} ;
         P00GB9_n273Trn_ThemeId = new bool[] {false} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_homepageapi__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00GB4_A523AppVersionId, P00GB4_A11OrganisationId, P00GB4_n11OrganisationId, P00GB4_A29LocationId, P00GB4_n29LocationId, P00GB4_A273Trn_ThemeId, P00GB4_n273Trn_ThemeId
               }
               , new Object[] {
               ...
               , new Object[] {
               P00GB7_A584ActiveAppVersionId, P00GB7_n584ActiveAppVersionId, P00GB7_A598PublishedActiveAppVersionId, P00GB7_n598PublishedActiveAppVersionId, P00GB7_A29LocationId, P00GB7_A11OrganisationId
               }
               , new Object[] {
               P00GB8_A273Trn_ThemeId, P00GB8_n273Trn_ThemeId
               }
               , new Object[] {
               P00GB9_A273Trn_ThemeId, P00GB9_n273Trn_ThemeId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string AV23ResidentLanguage ;
      ...
      private string AV24PagePublishedStructure ;
      ...
      private bool[] P00GB4_n273Trn_ThemeId ;
      ...
      private GxSimpleCollection<string> AV22Images ;
      ...
      private Guid[] P00GB7_A584ActiveAppVersionId ;
      private bool[] P00GB7_n584ActiveAppVersionId ;
      private Guid[] P00GB7_A598PublishedActiveAppVersionId ;
      private bool[] P00GB7_n598PublishedActiveAppVersionId ;
      private Guid[] P00GB7_A29LocationId ;
      private bool[] P00GB7_n29LocationId ;
      private Guid[] P00GB7_A11OrganisationId ;
      private bool[] P00GB7_n11OrganisationId ;
      private Guid[] P00GB8_A273Trn_ThemeId ;
      private bool[] P00GB8_n273Trn_ThemeId ;
      private Guid[] P00GB9_A273Trn_ThemeId ;
      private bool[] P00GB9_n273Trn_ThemeId ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00GB6", "SELECT WWPFormId, WWPFormReferenceName, WWPFormVersionNumber FROM WWP_Form WHERE WWPFormId = TO_NUMBER(0 || :AV15SDT__1Action_1Objectid,'9999999999999999999999999999.99999999999999') ORDER BY WWPFormId, WWPFormVersionNumber ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00GB6,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00GB7", "SELECT ActiveAppVersionId, PublishedActiveAppVersionId, LocationId, OrganisationId FROM Trn_Location WHERE LocationId = :AV8LocationId ORDER BY LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00GB7,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00GB8", "SELECT Trn_ThemeId FROM Trn_AppVersion WHERE AppVersionId = :PublishedActiveAppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00GB8,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00GB9", "SELECT Trn_ThemeId FROM Trn_AppVersion WHERE AppVersionId = :ActiveAppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00GB9,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
