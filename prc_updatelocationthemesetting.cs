   ...
   public class prc_updatelocationthemesetting : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            n273Trn_ThemeId = P00D92_n273Trn_ThemeId[0];
         ...
         if ( AV11LocationHasOwnBrand )
         {
            ...
            {
               A273Trn_ThemeId = P00D93_A273Trn_ThemeId[0];
               n273Trn_ThemeId = P00D93_n273Trn_ThemeId[0];
               ...
               while ( (pr_default.getStatus(2) != 101) )
               {
                  ...
                  n273Trn_ThemeId = P00D94_n273Trn_ThemeId[0];
                  A274Trn_ThemeName = P00D94_A274Trn_ThemeName[0];
                  A281Trn_ThemeFontFamily = P00D94_A281Trn_ThemeFontFamily[0];
                  A405Trn_ThemeFontSize = P00D94_A405Trn_ThemeFontSize[0];
                  AV31GXLvl19 = 1;
      ...
      protected void S111( )
      {
         ...
         pr_default.execute(10, new Object[] {AV10LocationId});
         while ( (pr_default.getStatus(10) != 101) )
         {
            GXTD911 = 0;
            A29LocationId = P00D912_A29LocationId[0];
            A577LocationThemeId = P00D912_A577LocationThemeId[0];
            n577LocationThemeId = P00D912_n577LocationThemeId[0];
            A11OrganisationId = P00D912_A11OrganisationId[0];
            ...
            pr_default.execute(11, new Object[] {n577LocationThemeId, A577LocationThemeId, A29LocationId, A11OrganisationId});
            pr_default.close(11);
      ...
      public override void initialize( )
      {
         ...
         P00D92_n273Trn_ThemeId = new bool[] {false} ;
         A274Trn_ThemeName = "";
         ...
         P00D93_A273Trn_ThemeId = new Guid[] {Guid.Empty} ;
         P00D93_n273Trn_ThemeId = new bool[] {false} ;
         ...
         P00D94_n273Trn_ThemeId = new bool[] {false} ;
         P00D94_A274Trn_ThemeName = new string[] {""} ;
         P00D94_A281Trn_ThemeFontFamily = new string[] {""} ;
         P00D94_A405Trn_ThemeFontSize = new short[1] ;
         ...
         P00D912_A29LocationId = new Guid[] {Guid.Empty} ;
         P00D912_A577LocationThemeId = new Guid[] {Guid.Empty} ;
         P00D912_n577LocationThemeId = new bool[] {false} ;
         P00D912_A11OrganisationId = new Guid[] {Guid.Empty} ;
         AV26CtaColor = new SdtTrn_Theme_CtaColor(context);
         AV27Color = new SdtTrn_Theme_Color(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_updatelocationthemesetting__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00D93_A273Trn_ThemeId, P00D93_n273Trn_ThemeId, P00D93_A577LocationThemeId, P00D93_n577LocationThemeId, P00D93_A29LocationId, P00D93_A11OrganisationId
               }
               , new Object[] {
               P00D94_A273Trn_ThemeId, P00D94_A274Trn_ThemeName, P00D94_A281Trn_ThemeFontFamily, P00D94_A405Trn_ThemeFontSize
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               P00D912_A29LocationId, P00D912_A577LocationThemeId, P00D912_n577LocationThemeId, P00D912_A11OrganisationId
               }
               , new Object[] {
               }
            }
      ...
      private bool[] P00D92_n273Trn_ThemeId ;
      ...
      private Guid[] P00D93_A273Trn_ThemeId ;
      private bool[] P00D93_n273Trn_ThemeId ;
      ...
      private bool[] P00D94_n273Trn_ThemeId ;
      private string[] P00D94_A274Trn_ThemeName ;
      private string[] P00D94_A281Trn_ThemeFontFamily ;
      private short[] P00D94_A405Trn_ThemeFontSize ;
      private SdtTrn_Theme_Icon AV21Icon ;
      private Guid[] P00D912_A29LocationId ;
      private Guid[] P00D912_A577LocationThemeId ;
      private bool[] P00D912_n577LocationThemeId ;
      private Guid[] P00D912_A11OrganisationId ;
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
          ...
          ,new CursorDef("P00D93", "SELECT Trn_ThemeId, LocationThemeId, LocationId, OrganisationId FROM Trn_Location WHERE LocationId = :AV10LocationId ORDER BY LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D93,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("P00D94", "SELECT Trn_ThemeId, Trn_ThemeName, Trn_ThemeFontFamily, Trn_ThemeFontSize FROM Trn_Theme WHERE Trn_ThemeId = :LocationThemeId ORDER BY Trn_ThemeId  FOR UPDATE OF Trn_Theme",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D94,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("P00D95", "DELETE FROM Trn_ThemeColor  WHERE Trn_ThemeId = :Trn_ThemeId", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00D95)
          ,new CursorDef("P00D96", "SAVEPOINT gxupdate;INSERT INTO Trn_ThemeColor(Trn_ThemeId, ColorId, ColorName, ColorCode) VALUES(:Trn_ThemeId, :ColorId, :ColorName, :ColorCode);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_MASKLOOPLOCK,prmP00D96)
          ,new CursorDef("P00D97", "DELETE FROM Trn_ThemeCtaColor  WHERE Trn_ThemeId = :Trn_ThemeId", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00D97)
          ,new CursorDef("P00D98", "SAVEPOINT gxupdate;INSERT INTO Trn_ThemeCtaColor(Trn_ThemeId, CtaColorId, CtaColorName, CtaColorCode) VALUES(:Trn_ThemeId, :CtaColorId, :CtaColorName, :CtaColorCode);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_MASKLOOPLOCK,prmP00D98)
          ,new CursorDef("P00D99", "DELETE FROM Trn_ThemeIcon  WHERE Trn_ThemeId = :Trn_ThemeId", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00D99)
          ,new CursorDef("P00D910", "SAVEPOINT gxupdate;INSERT INTO Trn_ThemeIcon(Trn_ThemeId, IconId, IconName, IconSVG, IconCategory) VALUES(:Trn_ThemeId, :IconId, :IconName, :IconSVG, :IconCategory);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_MASKLOOPLOCK,prmP00D910)
          ,new CursorDef("P00D911", "SAVEPOINT gxupdate;UPDATE Trn_Theme SET Trn_ThemeName=:Trn_ThemeName, Trn_ThemeFontFamily=:Trn_ThemeFontFamily, Trn_ThemeFontSize=:Trn_ThemeFontSize  WHERE Trn_ThemeId = :Trn_ThemeId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00D911)
          ,new CursorDef("P00D912", "SELECT LocationId, LocationThemeId, OrganisationId FROM Trn_Location WHERE LocationId = :AV10LocationId ORDER BY LocationId  FOR UPDATE OF Trn_Location",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00D912,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("P00D913", "SAVEPOINT gxupdate;UPDATE Trn_Location SET LocationThemeId=:LocationThemeId  WHERE LocationId = :LocationId AND OrganisationId = :OrganisationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00D913)
       };
    }
 }
