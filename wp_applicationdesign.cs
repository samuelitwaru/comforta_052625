...
namespace GeneXus.Programs {
   public class wp_applicationdesign : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256612565370", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_applicationdesign.js", "?20256612565371", false, true);
         context.AddJavascriptSource("UserControls/UC_AppToolBox1Render.js", "", false, true);
         context.AddJavascriptSource("UserControls/UC_PreventAccessModalRender.js", "", false, true);
