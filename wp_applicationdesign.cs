...
namespace GeneXus.Programs {
   public class wp_applicationdesign : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025641314399", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_applicationdesign.js", "?202564131443", false, true);
         context.AddJavascriptSource("UserControls/UC_AppToolBox1Render.js", "", false, true);
         context.AddJavascriptSource("UserControls/UC_PreventAccessModalRender.js", "", false, true);
