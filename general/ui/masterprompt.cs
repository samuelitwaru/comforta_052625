...
namespace GeneXus.Programs.general.ui {
   public class masterprompt : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm022( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterprompt.js", "?2025641382065", false, true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2025641382073", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("general/ui/masterprompt.js", "?2025641382074", false, true);
         }
