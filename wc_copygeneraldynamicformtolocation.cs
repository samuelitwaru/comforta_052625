...
namespace GeneXus.Programs {
   public class wc_copygeneraldynamicformtolocation : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255245484880", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wc_copygeneraldynamicformtolocation.js", "?20255245484880", false, true);
