   ...
   public class trn_environmentvariableview : GXDataArea
   {
      ...
      protected void RFBO2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A633EnvironmentVariableId = H00BO2_A633EnvironmentVariableId[0];
               /* Execute user event: Load */
               E15BO2 ();
      ...
      protected void E13BO2( )
      {
         ...
         {
            A633EnvironmentVariableId = H00BO3_A633EnvironmentVariableId[0];
            AV16GXLvl9 = 1;
            Form.Caption = A633EnvironmentVariableId.ToString();
      ...
      protected void E14BO2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_EnvironmentVariable",  StringUtil.Trim( A633EnvironmentVariableId.ToString())) )
         {
      ...
      protected void E11BO2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_EnvironmentVariable",(short)2,StringUtil.Trim( A633EnvironmentVariableId.ToString()),(string)AV13RecordDescription});
      ...
      protected void E12BO2( )
      {
         ...
         if ( AV15IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_EnvironmentVariable",StringUtil.Trim( A633EnvironmentVariableId.ToString()),(string)AV13RecordDescription,formatLink("trn_environmentvariableview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561013215841", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_environmentvariableview.js", "?202561013215841", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A633EnvironmentVariableId","fld":"ENVIRONMENTVARIABLEID"},{"av":"AV13RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV15IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV9EnvironmentVariableId","fld":"vENVIRONMENTVARIABLEID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11BO2","iparms":[{"av":"A633EnvironmentVariableId","fld":"ENVIRONMENTVARIABLEID"},{"av":"AV13RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12BO2","iparms":[{"av":"AV15IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV13RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A633EnvironmentVariableId","fld":"ENVIRONMENTVARIABLEID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H00BO2_A633EnvironmentVariableId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00BO3_A633EnvironmentVariableId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_environmentvariableview__default(),
            new Object[][] {
                new Object[] {
               H00BO2_A633EnvironmentVariableId
               }
               , new Object[] {
               H00BO3_A633EnvironmentVariableId
               }
            }
         );
      ...
      private Guid[] H00BO2_A633EnvironmentVariableId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00BO3_A633EnvironmentVariableId ;
