   ...
   public class trn_location_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void Load046( )
      {
         ...
         if ( (pr_default.getStatus(6) != 101) )
         {
            ...
            A632ToolBoxLastUpdateTime = BC00048_A632ToolBoxLastUpdateTime[0];
            n632ToolBoxLastUpdateTime = BC00048_n632ToolBoxLastUpdateTime[0];
      ...
      protected void OnDeleteControls046( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            n273Trn_ThemeId = BC000415_n273Trn_ThemeId[0];
            pr_default.close(13);
            ...
            n273Trn_ThemeId = BC000416_n273Trn_ThemeId[0];
            pr_default.close(14);
         }
         if ( AnyError == 0 )
         {
      ...
      public void ScanKeyStart046( )
      {
         ...
         if ( (pr_default.getStatus(23) != 101) )
         {
            ...
            A632ToolBoxLastUpdateTime = BC000425_A632ToolBoxLastUpdateTime[0];
            n632ToolBoxLastUpdateTime = BC000425_n632ToolBoxLastUpdateTime[0];
      ...
      public override void initialize( )
      {
         ...
         BC00048_A632ToolBoxLastUpdateTime = new DateTime[] {DateTime.MinValue} ;
         BC00048_n632ToolBoxLastUpdateTime = new bool[] {false} ;
         ...
         BC000415_n273Trn_ThemeId = new bool[] {false} ;
         BC000416_A273Trn_ThemeId = new Guid[] {Guid.Empty} ;
         BC000416_n273Trn_ThemeId = new bool[] {false} ;
         ...
         BC000421_A89ReceptionistId = new Guid[] {Guid.Empty} ;
         ...
         BC000425_A632ToolBoxLastUpdateTime = new DateTime[] {DateTime.MinValue} ;
         BC000425_n632ToolBoxLastUpdateTime = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_location_bc__default(),
            new Object[][] {
               ...
               , new Object[] {
               BC000415_A273Trn_ThemeId, BC000415_n273Trn_ThemeId
               }
               , new Object[] {
               BC000416_A273Trn_ThemeId, BC000416_n273Trn_ThemeId
               }
               , new Object[] {
               ...
               , new Object[] {
               BC000421_A89ReceptionistId, BC000421_A11OrganisationId, BC000421_A29LocationId
               }
               , new Object[] {
      ...
      private DateTime[] BC00048_A632ToolBoxLastUpdateTime ;
      private bool[] BC00048_n632ToolBoxLastUpdateTime ;
      ...
      private bool[] BC000415_n273Trn_ThemeId ;
      private Guid[] BC000416_A273Trn_ThemeId ;
      private bool[] BC000416_n273Trn_ThemeId ;
      ...
      private Guid[] BC000421_A89ReceptionistId ;
      ...
      private DateTime[] BC000425_A632ToolBoxLastUpdateTime ;
      private bool[] BC000425_n632ToolBoxLastUpdateTime ;
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
          ...
          ,new CursorDef("BC000421", "SELECT ReceptionistId, OrganisationId, LocationId FROM Trn_Receptionist WHERE LocationId = :LocationId AND OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000421,1, GxCacheFrequency.OFF ,true,true )
