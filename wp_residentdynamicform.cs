...
namespace GeneXus.Programs {
   public class wp_residentdynamicform : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202568743245", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_residentdynamicform.js", "?202568743245", false, true);
         context.AddJavascriptSource("UserControls/UC_DynamicFormJSCSSRender.js", "", false, true);
